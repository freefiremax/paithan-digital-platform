      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-gradient-to-r from-[#071224] via-[#0C1E3C] to-[#122B54] text-white rounded-3xl p-6 sm:p-10 shadow-xl border border-amber-500/20 relative overflow-hidden">
          <div className="relative z-10 max-w-3xl">
            ...
            <p className="text-sm text-slate-300 mt-2 leading-relaxed">
              Complete pilgrim directory to the sanctified temples, riverside ghats, and archaeological excavation mounds of Paithan on the holy Godavari.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          {HERITAGE_SITES.map((site) => (
            <div
              key={site.id}
              className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm hover:border-amber-400/80 transition-all flex flex-col lg:flex-row gap-6"
            >
